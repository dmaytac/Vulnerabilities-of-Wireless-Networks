...
<p>After select the **Captive Portal** from the first interface, select the _Rogue AP - hostpd_(picture 1.7).</p>
...
<p>In picture 1.8, we choose use hash found. After that, select the _cowpatty_ verification.</p>
