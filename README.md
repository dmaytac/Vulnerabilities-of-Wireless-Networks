...
<p>After select the Captive Portal from the first interface, select the Rogue AP - hostpd(picture 1.7).</p>
...
<p align="center">Image 1.7</p>

<p>In picture 1.8, we choose use hash found. After that, select the cowpatty verification.</p>
...
<p align="center">Image 1.8</p>

<p>If we choose "None (disable SSL)" this will cause warnings to users because the browser will have to send forms over an unencrypted connection. In this case, we choose to create an SSL certificate(image 1.9).</p>
...
<p align="center">![image](https://user-images.githubusercontent.com/120057560/211591711-7648a348-9d8e-44d3-9103-926951e55ba5.png)
